...
sealed interface EditorAction {
    ...
    data class SplitBlock(val index: Int, val cursorStart: Int, val onFocusCalculated: (newFocusIndex: Int) -> Unit) : EditorAction
    data class BlockTurnedIntoMoreBlocks(val index: Int, val newBlocks: List<String>) : EditorAction
    data class EvaluateBlockOnFocusLost(val index: Int, val currentFocusedIndex: Int?, val onFocusAdjusted: (newFocus: Int?) -> Unit) : EditorAction
}